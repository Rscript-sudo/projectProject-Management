...
const api = {
  ...
  resolveTemplateContext: (payload) => ipcRenderer.invoke('field:resolveTemplateContext', payload),
  ...
  openTemplatePreview: (filePath, displayName) => ipcRenderer.invoke('shell:openTemplatePreview', filePath, displayName),
  ...
  deleteProfessionalTemplateCategory: (projectType, projectTypeCode) => ipcRenderer.invoke('template:deleteProfessional', { projectType, projectTypeCode }),
  getTemplateWorkspaceInfo: () => ipcRenderer.invoke('template:workspaceInfo'),
  createProfessionalTemplateCategory: (projectType) => ipcRenderer.invoke('template:createProfessional', { projectType }),
  listTemplateCategories: (scope = 'other') => ipcRenderer.invoke('template:listCategories', { scope }),
  createTemplateCategory: (scope, name) => ipcRenderer.invoke('template:createCategory', { scope, name }),
  deleteTemplateCategory: (scope, name) => ipcRenderer.invoke('template:deleteCategory', { scope, name }),
  updateLibraryTemplate: (payload) => ipcRenderer.invoke('template:updateLibrary', payload),
  markTemplateRuleConfigured: (id) => ipcRenderer.invoke('template:markRuleConfigured', { id }),
  getTemplateLayoutContract: (filePath, docType) => ipcRenderer.invoke('template:getLayoutContract', { path: filePath, docType }),
  saveTemplateLayoutContract: (filePath, docType, fields) => ipcRenderer.invoke('template:saveLayoutContract', { path: filePath, docType, fields }),
  resetTemplateLayoutContract: (filePath, docType) => ipcRenderer.invoke('template:resetLayoutContract', { path: filePath, docType }),
