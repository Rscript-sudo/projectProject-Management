...
export const PROJECT_TYPE_OPTIONS = [
  {
    ...
    // 不把“模板”作为禁用词：它既是土建工序，也常出现在“项目模板/模板字段”中，
    // 会误杀正常的文档交付。专业门禁只拦截具有明确土建语义的术语。
    forbiddenTerms: ['塔吊', '施工升降机', '木工', '扬尘', '混凝土', '钢筋', '砌体', '脚手架', '深基坑', '高支模'],
  },
  {
  ...
  },
  {
    ...
    forbiddenTerms: ['塔吊', '施工升降机', '木工', '扬尘', '钢筋', '砌体', '脚手架', '深基坑', '高支模'],
  },
  {
