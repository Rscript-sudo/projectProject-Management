...
export default function DeliveryCenterView() {
  ...
  if (!currentProject) return <div className="app-page">请先选择项目</div>
  ...
  return <div className="app-page">
    <header className="app-page-header">
      <div className="app-page-heading"><span className="app-page-heading__icon"><ExportOutlined /></span><div className="app-page-heading__copy"><Title level={3} className="app-page-heading__title">导入与交付中心</Title><Text className="app-page-heading__description">{currentProject.name} · 统一校验数据并生成正式交付件</Text></div></div>
      <div className="app-page-actions"><Button icon={<ArrowLeftOutlined />} onClick={() => navigate(-1)}>返回项目</Button></div>
    </header>
    <Card title="统一导入" size="small" className="app-content-card" style={{ marginBottom: 16 }}>
