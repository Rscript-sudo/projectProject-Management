...
export interface ElectronAPI {
  ...
  listTemplateLibrary: () => Promise<Array<{ id: string; name: string; docType: string; scope: 'global' | 'professional' | 'other' | 'personal'; projectType: string; projectTypeLabel?: string; resourceKind?: 'document' | 'site-package'; path: string; sourceName: string; fields?: string[]; aiRuleConfiguredAt?: string; layoutContract?: { status?: string; warningCount?: number; choiceGroupCount?: number; schemaVersion?: number; templateHash?: string; fieldCount?: number; placementCount?: number; exactPlacementCount?: number }; createdAt: string; updatedAt: string }>>
  listSystemTemplates: () => Promise<Array<{ id: string; name: string; docType: string; scope: 'system'; projectType: string; resourceKind?: 'document' | 'site-package'; path: string; sourceName: string; fields?: string[]; readOnly: true }>>
  importTemplateToLibrary: (payload: { sourcePath: string; docType: string; scope: 'global' | 'professional' | 'other' | 'personal'; projectType?: string; name?: string; resourceKind?: 'document' | 'site-package' }) => Promise<{ success: boolean; template?: any; error?: string }>
