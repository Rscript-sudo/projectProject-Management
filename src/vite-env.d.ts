...
export interface ElectronAPI {
  ...
  listTemplateLibrary: () => Promise<Array<{ id: string; name: string; docType: string; scope: 'global' | 'professional' | 'other' | 'personal'; projectType: string; projectTypeLabel?: string; resourceKind?: 'document' | 'site-package'; path: string; sourceName: string; fields?: string[]; aiRuleConfiguredAt?: string; createdAt: string; updatedAt: string }>>
